...
public class FutureStops extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_future_stops);
    ...
    private void loadBarChartData() {
        String url = "http://192.168.1.11:5000/future_stops_to";
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            JSONObject destinations = response.getJSONObject("to");
