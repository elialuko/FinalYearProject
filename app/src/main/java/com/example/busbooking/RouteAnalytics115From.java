...
public class RouteAnalytics115From extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route_analytics115_from);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Tuesday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            //anyChartView.clear();
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Wednesday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            //anyChartView.clear();
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Thursday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            anyChartView.clear();
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Friday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            anyChartView.clear();
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Saturday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            anyChartView.clear();
                ...
                }else if(mySpinner.getSelectedItem().toString().equalsIgnoreCase("Sunday")){
                    userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            anyChartView.clear();
